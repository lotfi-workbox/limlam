...
class ThemedCollapsingToolbarLayout(override var ctx: Context) : CollapsingToolbarLayout(ctx),
    BaseViewGroup<Context, CollapsingToolbarLayout>, ThemeManager.ThemeChangedListener {
